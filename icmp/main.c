...
int main() {
  ...
  u8 frame[] = {0x78, 0x9a, 0x18, 0x33, 0x29, 0x6a, 0xe0, 0x2b, 0xe9, 0xab,
                0xa2, 0x39, 0x08, 0x00, 0x45, 0x00, 0x00, 0x54, 0x02, 0x7e,
                0x40, 0x00, 0x40, 0x01, 0xb2, 0xd7, 0xc0, 0xa8, 0x02, 0x02,
                0xc0, 0xa8, 0x02, 0x01, 0x08, 0x00, 0x3c, 0xa5, 0xb9, 0xac,
                0x00, 0x01, 0xe5, 0x6a, 0xe1, 0x67, 0x00, 0x00, 0x00, 0x00,
                0x70, 0x07, 0x0c, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x11,
  ...
  ipv4_header ipv4 = {
      ...
      .protocol = (0x01),
      .header_checksum =
          htons(0xb2d7), /* TODO: create function to calculate checksum */
  ...
  for (size_t i = sizeof(eth_header);
       i < sizeof(eth_header) + sizeof(ipv4_header); i++)
    printf("%02X ", frame[i]);
  printf("\n\n");
